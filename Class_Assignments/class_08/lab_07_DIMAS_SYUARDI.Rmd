...
```{r}
# Countyfips is one column that is not in the population table that could be an issue moving forward as it is good data that could help combine the two data sets. Also, county_name not in the pills data could be an issue moving forward as well.
```
